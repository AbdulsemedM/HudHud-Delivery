...
class _StoreDetailScreenState extends State<StoreDetailScreen> {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          if (_totalItems > 0) _buildCartBar(context),
        ],
      ),
    );
  }
    ...
    if (widget.vendor != null) {
      return SliverAppBar(
        ...
        flexibleSpace: FlexibleSpaceBar(
          ...
          background: _VendorHeroBackground(
  ...
  List<Widget> _buildBodySlivers(BuildContext context) {
    ...
    if (widget.vendorId == null) {
      return [
        SliverToBoxAdapter(child: _buildStaticContent()),
      ];
    }
    ...
    if (_isLoadingActiveProducts) {
      return const [
        SliverToBoxAdapter(child: _StoreProductsShimmer()),
      ];
    }

    if (_productsError != null && _selectedTab != 'Featured') {
      return [
        SliverFillRemaining(
          hasScrollBody: false,
          child: Center(
    ...
    return _buildProductSlivers(context);
  }
  ...
  List<Widget> _buildProductSlivers(BuildContext context) {
    ...
    return [
      ...
      ...sections.map((e) {
        final title = e.key != null ? 'Category ${e.key}' : context.l10n.noProducts;
      ...
      SliverToBoxAdapter(
        child: SizedBox(height: _totalItems > 0 ? 96 : 24),
      ),
    ];
  }
        ...
        child: SafeArea(
          ...
          child: Row(
            children: [
              ...
              Expanded(
                child: Text(
                  '$_totalItems ${l10n.orders.toLowerCase()}',
              ...
              Text(
                '${l10n.currencyEtb}${_totalPrice.toStringAsFixed(1)}',
                style: const TextStyle(
                  color: Colors.white,
                  fontSize: 16,
...
class _VendorHeroBackground extends StatelessWidget {
  final VendorModel vendor;
  final List<BranchModel> branches;

  const _VendorHeroBackground({
                ...
                children: [
                  ...
                  if (vendor.status == 'active')
                    _VendorInfoChip(
                      ...
                      label: context.l10n.orderStatusConfirmed,
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Text(
                                  context.l10n.estimatedDeliveryPlaceholder,
                                  style: TextStyle(
                                    fontSize: 11,
                                    fontWeight: FontWeight.w600,
                                    color: Colors.white
...
class _StorePillSearchRow extends StatefulWidget {
  const _StorePillSearchRow({
    required this.hint,
  ...
  @override
  State<_StorePillSearchRow> createState() => _StorePillSearchRowState();
}

class _StorePillSearchRowState extends State<_StorePillSearchRow> {
...
class _StoreProductsShimmer extends StatelessWidget {
  const _StoreProductsShimmer();
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isSelected ? AppColors.primaryColor : colorScheme.surface,
          borderRadius: BorderRadius.circular(AppColors.rFull),
          border: Border.all(
            color: AppColors.primaryColor,
            width: 1.5,
